// CÀLCUL DELS ADJUNTS DELS ELEMENTS D'UNA MATRIU
...
int main(){
	...
	int n;
	long double M1[2][2], MAdj1[2][2], M2[3][3], MTA2[3][3], M3[4][4], MTA3[4][4];

	
	cout << "// CALCUL DELS ADJUNTS DELS ELEMENTS D'UNA MATRIU\n// TREBALL DE RECERCA 2018-2020. OMAR BRIQA\n";
		
		a:cout << "\nEsculli el rang de la seva matriu: " << endl;
		...
		cin >> n;
			...
			if ( n == 2 ){
				...
				cout << "\nLa matriu adjunta es la seguent: " << endl;
